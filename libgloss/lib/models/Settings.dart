...
class Settings extends Model {
  ...
  const Settings._internal({required this.id, notifications, createdAt, updatedAt}): _notifications = notifications, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory Settings({String? id, bool? notifications}) {
  ...
  Settings copyWith({bool? notifications}) {
    return Settings._internal(
      id: id,
  ...
  Map<String, dynamic> toJson() => {
    'id': id, 'notifications': _notifications, 'createdAt': _createdAt?.format(), 'updatedAt': _updatedAt?.format()
  };
  
  Map<String, Object?> toMap() => {
    'id': id, 'notifications': _notifications, 'createdAt': _createdAt, 'updatedAt': _updatedAt
  };

  static final QueryModelIdentifier<SettingsModelIdentifier> MODEL_IDENTIFIER = QueryModelIdentifier<SettingsModelIdentifier>();
  static final QueryField ID = QueryField(fieldName: "id");
  static final QueryField NOTIFICATIONS = QueryField(fieldName: "notifications");
 ...
 */
@immutable
class SettingsModelIdentifier implements ModelIdentifier<Settings> {
  final String id;
