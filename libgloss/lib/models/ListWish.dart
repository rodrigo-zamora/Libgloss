...
class ListWish extends Model {
  ...
  ListWishModelIdentifier get modelIdentifier {
    return ListWishModelIdentifier(id: id);
  }
  ...
  const ListWish._internal(
      {required this.id, Tracking, Wish, createdAt, updatedAt})
      : _Tracking = Tracking,
        _Wish = Wish,
  ...
  static final QueryModelIdentifier<ListWishModelIdentifier> MODEL_IDENTIFIER =
      QueryModelIdentifier<ListWishModelIdentifier>();
...
class ListWishModelIdentifier implements ModelIdentifier<ListWish> {
  ...
  const ListWishModelIdentifier({required this.id});
  ...
  bool operator ==(Object other) {
    ...
    return other is ListWishModelIdentifier && id == other.id;
  }
